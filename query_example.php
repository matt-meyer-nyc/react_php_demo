<?php
  ...
  //  create Table (in phpMyAdmin, go to root of database, and click SQL to run this query to create Table)
 ...
 // same process as above, but inserts these fields into Table created above
  ...
  //  same process above but 'dumps' Date for fields created above
